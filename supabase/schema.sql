...
from (values
  ...
  ('スターバックス', '外食', 1),
  ('matsuya', '外食', 1),
  -- 有名飲食チェーン（新しく利用しても自動で「外食」に分類されるよう先回りで登録）
  ('マクドナルド', '外食', 1), ('mcdonald', '外食', 1),
  ('モスバーガー', '外食', 1), ('mosburger', '外食', 1),
  ('ケンタッキー', '外食', 1), ('kfc', '外食', 1),
  ('バーガーキング', '外食', 1), ('burger king', '外食', 1),
  ('吉野家', '外食', 1), ('yoshinoya', '外食', 1),
  ('すき家', '外食', 1), ('sukiya', '外食', 1),
  ('なか卯', '外食', 1), ('nakau', '外食', 1),
  ('松屋', '外食', 1),
  ('やよい軒', '外食', 1), ('yayoiken', '外食', 1),
  ('リンガーハット', '外食', 1), ('ringerhut', '外食', 1),
  ('丸亀製麺', '外食', 1), ('marugame', '外食', 1),
  ('スシロー', '外食', 1), ('sushiro', '外食', 1),
  ('くら寿司', '外食', 1), ('kurazushi', '外食', 1),
  ('はま寿司', '外食', 1), ('hamazushi', '外食', 1),
  ('ガスト', '外食', 1), ('gusto', '外食', 1),
  ('サイゼリヤ', '外食', 1), ('saizeriya', '外食', 1),
  ('デニーズ', '外食', 1), ('dennys', '外食', 1),
  ('ロイヤルホスト', '外食', 1), ('royalhost', '外食', 1),
  ('ドトール', '外食', 1), ('doutor', '外食', 1),
  ('タリーズ', '外食', 1), ('tullys', '外食', 1),
  ('コメダ', '外食', 1), ('komeda', '外食', 1),
  ('大戸屋', '外食', 1), ('ootoya', '外食', 1),
  ('ココイチ', '外食', 1), ('ichibanya', '外食', 1),
  ('王将', '外食', 1), ('ohsho', '外食', 1),
  ('てんや', '外食', 1), ('tenya', '外食', 1),
  ('ミスタードーナツ', '外食', 1), ('misdo', '外食', 1),
  ('サブウェイ', '外食', 1), ('subway', '外食', 1),
  ('ピザハット', '外食', 1), ('pizzahut', '外食', 1),
  ('ドミノ', '外食', 1), ('dominos', '外食', 1),
  ('ピザーラ', '外食', 1), ('pizzala', '外食', 1),
  ('一風堂', '外食', 1), ('ippudo', '外食', 1),
  ('幸楽苑', '外食', 1), ('kourakuen', '外食', 1),
  ('日高屋', '外食', 1), ('hidakaya', '外食', 1),
  ('マツモトキヨシ', '日用品', 1),
  ('drug', '日用品', 1),
  ('icoca', '交通費', 1),
  ('ｉｃｏｃａ', '交通費', 1),
